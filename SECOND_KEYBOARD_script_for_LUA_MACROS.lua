...
local keyboardIdentifier = '258BA60F'
...
sendToAHK = function (key)
      ...
      local file = io.open("C:\\Users\\Larry\\Documents\\Github\\macros\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
